...
//            }
//        });
        storage.getReferenceFromUrl("gs://quest-8f3ba.appspot.com/images/profile/"
                        + currentUserLocalType.getEmail())
                .getDownloadUrl()
            ...
            public void onComplete(@NonNull Task<Uri> task) {
                if (task.isSuccessful()) {
                    ...
                    Log.d("main activity/onUploadButtonPressed", "onComplete: download url = "
                            + downUrl);
            ...
            public void onComplete(@NonNull Task<Uri> task) {
                if (task.isSuccessful()) {
                    ...
                    Log.d("on upload button pressed", "onComplete: "
                            + currentUserLocalType.getProfilePicture());
